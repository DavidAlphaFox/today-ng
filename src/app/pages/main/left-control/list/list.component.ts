...
import {
  NzDropdownService,
  NzDropdownContextComponent, NzModalService
} from 'ng-zorro-antd';
...
export class ListComponent implements OnInit, OnDestroy {
  ...
  private currentListUuid$: Subscription;
  ...
  ngOnInit() {
    ...
    this.currentListUuid$ = this.listService
      .getCurrentListUuidSubject()
      .subscribe(uuid => {
  ...
  ngOnDestroy() {
    ...
    this.currentListUuid$.unsubscribe();
  }
